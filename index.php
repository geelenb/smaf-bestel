						...
						?>
							<li class="mdl-list__item mdl-list__item--two-line">
								<span class="mdl-list__item-primary-content">
									...
									<?php if ($u['jaar'] === $ploeg) { ?>
											<i class="material-icons mdl-list__item-avatar trui" style="background: url(img/team.png); float:right"></i>
									<?php } ?>
									<?php if ($u['uid'] === $groen_id) { ?>
											<i class="material-icons mdl-list__item-avatar trui" style="background: url(img/groen.png); float:right"></i>
									<?php } ?>
									<?php if ($u['uid'] === $bollen_id) { ?>
											<i class="material-icons mdl-list__item-avatar trui" style="background: url(img/bollen.png); float:right"></i>
									<?php } ?>
									<?php if ($wit_found === false && $u['uid'] === 1998) { ?>
											<i class="material-icons mdl-list__item-avatar trui" style="background: url(img/wit.png); float:right"></i>
									<?php } ?>
									<?php if ($i === 1) { ?>
											<i class="material-icons mdl-list__item-avatar trui" style="background: url(img/geel.png); float:right"></i>
									<?php } ?>
									<!-- <i class="material-icons mdl-list__item-avatar trui" style="background: url(img/team.png); float:right"></i> -->
