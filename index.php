			...
			<header class="mdl-layout__header">
				<div class="mdl-layout__header-row" style='padding: 0;'>
					...
					<?php # if (isset($_GET['utm_source'])) { ?>
						<button id="refreshbutton" class="mdl-button mdl-button--icon mdl-js-button mdl-js-ripple-effect" onClick="window.location.reload()" style="position: absolute; right: 24px;">
